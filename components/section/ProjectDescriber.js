...
export default function ProjectDescriber({leftDisplay, rightDisplay}) {
  return (
    ...
    <div className="container mx-auto w-11/12 lg:w-9/12">
      <div className="flex flex-col lg:flex-row mx-0 flex-wrap justify-center items-center w-full bg-gray-100 dark:bg-dark-800 rounded-4xl p-5">
        <div className="w-full lg:w-[40%] lg:max-w-[40%] lg:basis-[40%]">
          <div className="flex items-stretch justify-center">
            <div
              className="flex text-center p-2 shadow-2xl w-full h-full rounded-4xl"
            >
